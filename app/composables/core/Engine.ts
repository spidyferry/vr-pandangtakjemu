...
import type { IEngine } from '../types/index';
...
export class CreateEngine implements IEngine {
  ...
  public GetLoading(loadingManager?: THREE.LoadingManager, onLoad?: () => void, onProgress?: (url: string, itemsLoaded: number, itemsTotal: number) => void, onError?: (url: string) => void): void {
